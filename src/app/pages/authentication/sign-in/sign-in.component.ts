...
export class SignInComponent {
  ...
  async signIn() { // Mark the function as 
    const usernameInput = document.getElementById('usernameLogin') as HTMLInputElement;
    ...
    if (!usernameInput.value.trim() || !passwordInput.value.trim()) {
      ...
      if (!usernameInput.value.trim()) {
        ...
        usernameInput.insertAdjacentHTML('afterend', '<span style="color: red">required</span><i class="fas fa-exclamation-circle" style="color: red"></i>');      }
      if (!passwordInput.value.trim()) {
        passwordInput.style.borderColor = 'red';
        passwordInput.insertAdjacentHTML('afterend', '<span style="color: red">required</span><i class="fas fa-exclamation-circle" style="color: red"></i>');
      }
  ...
  sendPasswordRecovery() {
    ...
    alert('Your username and password have been sent to ' + this.emailForRecovery);
